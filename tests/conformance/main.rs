...
//! implementation with a linear axis scan and remainder-based rounding, or
//! from hand computation shown in comments. `ph-curves` is not an oracle and
//! `scripts/ci.sh` fails if this directory names it or a float.
//!
